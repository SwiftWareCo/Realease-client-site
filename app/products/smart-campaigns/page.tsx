...
function SmartCampaignsContent() {
    ...
    return (
        <>
            <Link href={fromSection ? "/#smart-campaigns" : "/"} style={{ position: "fixed", top: 80, left: 24, zIndex: 1000, display: "inline-flex", alignItems: "center", gap: 6, fontSize: "0.85rem", color: "#3B82F6", textDecoration: "none", fontWeight: 600, background: "rgba(255,255,255,0.85)", backdropFilter: "blur(12px)", padding: "8px 16px", borderRadius: 50, border: "1px solid rgba(59,130,246,0.15)", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
            ...
            <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", paddingTop: 100, paddingBottom: 60, position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "absolute", top: -100, right: -100, width: 600, height: 600, borderRadius: "50%", background: "radial-gradient(circle, rgba(59,130,246,0.10), transparent 70%)", filter: "blur(60px)", pointerEvents: "none" }} />

                <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", width: "100%", position: "relative", zIndex: 1 }}>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>

                            <div style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "12px 28px", background: "rgba(59,130,246,0.06)", borderRadius: 50, marginBottom: 24, border: "1px solid rgba(59,130,246,0.12)" }}>
                                <Sparkles size={18} style={{ color: "#3B82F6" }} />
                                <span style={{ fontSize: "0.95rem", fontWeight: 600, color: "#3B82F6" }}>Smart Campaigns</span>
                            </div>
                            ...
                            <h1 style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", fontWeight: 800, lineHeight: 1.1, fontFamily: "var(--font-dm-sans)", letterSpacing: "-0.04em", marginBottom: 20 }}>
                                Outreach That{" "}
                                <span style={{ background: "linear-gradient(135deg, #3B82F6, #2563EB, #1D4ED8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                                    Thinks for You.
                                </span>
                            </h1>
                            ...
                            <div style={{ display: "flex", gap: 24, marginBottom: 32 }}>
                                {[{ value: "68%", label: "Open Rate" }, { value: "22%", label: "Reply Rate" }, { value: "50+", label: "Templates" }].map((s) => (
                                    <div key={s.label}>
                                        <p style={{ fontSize: "1.5rem", fontWeight: 800, color: "#3B82F6", fontFamily: "var(--font-dm-sans)" }}>{s.value}</p>
                ...
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
                        {features.map((f, i) => (
                            ...
                            >
                                <div style={{ width: 48, height: 48, borderRadius: 12, background: "rgba(59,130,246,0.06)", display: "flex", alignItems: "center", justifyContent: "center", color: "#3B82F6", marginBottom: 16 }}>{f.icon}</div>
            ...
            <section style={{ padding: "100px 24px", background: "#0F172A" }}>
                <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
                    ...
                    <button onClick={openCalendly} style={{ padding: "16px 40px", background: "linear-gradient(135deg, #3B82F6, #2563EB)", color: "white", border: "none", borderRadius: 50, fontSize: "1rem", fontWeight: 700, cursor: "pointer", boxShadow: "0 4px 24px rgba(59,130,246,0.3)" }}>
