                ...
                <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", width: "100%", position: "relative", zIndex: 1 }}>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
                            <Link href="/" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: "0.85rem", color: "#4F46E5", textDecoration: "none", marginBottom: 24, fontWeight: 600 }}>
                                <ArrowLeft size={16} /> Back to Home
                            </Link>

                            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "8px 20px", background: "rgba(79,70,229,0.06)", borderRadius: 50, marginBottom: 24, border: "1px solid rgba(79,70,229,0.12)" }}>
                                <Phone size={14} style={{ color: "#4F46E5" }} />
                                <span style={{ fontSize: "0.8rem", fontWeight: 600, color: "#4F46E5" }}>AI Receptionist</span>
                            </div>
