                ...
                <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", width: "100%", position: "relative", zIndex: 1 }}>
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
                            <Link href="/" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: "0.85rem", color: "#7C3AED", textDecoration: "none", marginBottom: 24, fontWeight: 600 }}>
                                <ArrowLeft size={16} /> Back to Home
                            </Link>

                            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "8px 20px", background: "rgba(124,58,237,0.06)", borderRadius: 50, marginBottom: 24, border: "1px solid rgba(124,58,237,0.12)" }}>
                                <MessageSquare size={14} style={{ color: "#7C3AED" }} />
                                <span style={{ fontSize: "0.8rem", fontWeight: 600, color: "#7C3AED" }}>SMS Bot</span>
                            </div>
